...
ctype_pin_inst synthetic_fe_generate_next(uns proc_id, bool offpath) {
  switch (kernel) {
    case MEM_BANDWIDTH_LIMITED: {
      static auto kernel_map{generate_load_kernel(NO_DEPENDENCE_CHAIN, 500, UNIFORM_SEQUENTIAL, (ICACHE_LINE_SIZE), 4,
...
ctype_pin_inst get_next_cbr_kernel_type_inst(uns proc_id, bool offpath, double t_nt_ratio) {
  ...
  this predictor learns the pattern for bias ratios other than 50/50 T/NT */
