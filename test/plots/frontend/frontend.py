...
hatches=['.','/','x','\\','+']
colors=['#57A86B', '#5BB8D7','#A8A857','#6E4587','#ADEBCC','#EBDCAD']
density=5
...
ax.set_ylabel('Stalled slots (\%)')
ax.legend(ncol=1,columnspacing=0.25)
ax.grid(linestyle='--',zorder=0)
plt.axhline(0, color='gray')
plt.tight_layout()
fig.savefig("frontend.pdf",bbox_inches='tight',pad_inches=0)
