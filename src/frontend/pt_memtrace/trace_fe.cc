...
void output_counts(uint64_t num_of_segments, bb_counts counts_dynamic, bb_counts counts_as_built,
  ...
  const char *op_type_strings[] = {
      "TRACE_INST_TAKEN_NOT_CF", "TRACE_INST_TAKEN_CF_BR",  "TRACE_INST_TAKEN_CF_CBR",   "TRACE_INST_TAKEN_CF_CALL",
      "TRACE_INST_TAKEN_CF_REP", "TRACE_INST_TAKEN_CF_IBR", "TRACE_INST_TAKEN_CF_ICALL", "TRACE_INST_TAKEN_CF_ICO",
